...
public sealed class ChatService : BackgroundService
{
    ...
    private readonly IOptionsMonitor<HearthServerOptions> _opts;
    ...
    public ChatService(ILogger<ChatService> log, IOptionsMonitor<HearthServerOptions> opts)
    {
        _log = log;
        _opts = opts;
    ...
    /// <summary>
    /// Public ingest path for messages typed by a player in their HearthHud
    ...
    // ---------- Outbound drain (Lua -> HearthServer) ----------
    ...
    // ---------- Inbound append (HearthServer -> Lua) ----------
