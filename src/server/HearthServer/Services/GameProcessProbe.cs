...
/// <summary>
/// Reports whether the Bellwright game process named in <c>GamePidFile</c> is alive.
...
{
    // Matches BellwrightGame-Win64-Shipping(.exe); ProcessName has no extension.
    private const string ExeNameFragment = "BellwrightGame";
